...
// CheckAndFocusExistingInstance attempts to find an existing instance and focus it
// Returns true if an existing instance was found and focused, false otherwise
func CheckAndFocusExistingInstance() bool {
	hwnd := findExistingInstance()
	if hwnd == 0 {
		// No existing window found
		return false

...
func TestDoUpgrade(t *testing.T) {
	...
	if err := os.Chmod(BundlePath, 0500); err != nil {
	...
	if err := os.Chmod(BundlePath, 0755); err != nil {
...
func TestAlreadyMoved(t *testing.T) {
	...
	tmpDir, err := os.MkdirTemp("", "TestAlreadyMoved")
	if err != nil {
		t.Fatal("failed to create temp dir")
	}
	testApp := filepath.Join(tmpDir, "Ollama.app")
	err = os.MkdirAll(filepath.Join(testApp, "Contents", "MacOS"), 0755)
	if err != nil {

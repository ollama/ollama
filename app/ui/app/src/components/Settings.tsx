...
import { getSettings, updateSettings, getChats, deleteChat } from "@/api";
...
export default function Settings() {
  ...
  const deleteAllChatsMutation = useMutation({
    ...
    onError: (err) => {
      ...
      setShowDeleteError("Failed to delete all chats. Please try again.");
    },
  });
  ...
  return (
    <main className="flex h-screen w-full flex-col select-none dark:bg-neutral-900">
      ...
      <div className="w-full p-6 overflow-y-auto flex-1 overscroll-contain">
        ...
        {/* Delete success */}
        {showDeleteSuccess && (
          <div className="fixed bottom-4 left-1/2 transform -translate-x-1/2 transition-opacity duration-300 z-50 pointer-events-none">
            <Badge
              color="green"
              className="!bg-green-500 !text-white dark:!bg-green-600"
            >

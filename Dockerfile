...
WORKDIR /go/src/github.com/jmorganca/ollama/llm
ARG CGO_CFLAGS
RUN OLLAMA_SKIP_CPU_GENERATE=1 scripts/build_linux.sh
...
RUN OLLAMA_CPU_TARGET="cpu" scripts/build_linux.sh
FROM --platform=linux/amd64 cpu-builder-amd64 AS cpu_avx-build-amd64
RUN OLLAMA_CPU_TARGET="cpu_avx" scripts/build_linux.sh
FROM --platform=linux/amd64 cpu-builder-amd64 AS cpu_avx2-build-amd64
RUN OLLAMA_CPU_TARGET="cpu_avx2" scripts/build_linux.sh

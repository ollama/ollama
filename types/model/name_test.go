...
const (
	...
	part96  = "999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999"
	part97  = "9999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999999"
...
func TestParseNameParts(t *testing.T) {
	cases := []struct {
		...
		{
			in: part80 + "/" + part80 + "/" + part96 + ":" + part80,
			want: Name{
				Host:      part80,
				Namespace: part80,
				Model:     part96,
			...
			wantFilepath: filepath.Join(part80, part80, part96, part80),
		},
	}

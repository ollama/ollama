...
// positions. Zeroing hidden and cState makes a padded row's output zero, and
// -inf dt gives softplus 0, hence decay 1 and no state update — so a padded
// position is an identity step.

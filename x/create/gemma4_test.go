...
func TestGemma4QuantizationType(t *testing.T) {
	...
	tests := []struct {
		...
		// === lm_head: promote for 4-bit base quants, passthrough for 8-bit ===
		{"lm_head int4 base", transform26B, "model.lm_head.weight", aligned, "int4", "int8"},
		{"lm_head nvfp4 base", transform26B, "model.lm_head.weight", aligned, "nvfp4", "nvfp4"},
		{"lm_head mxfp4 base", transform26B, "model.lm_head.weight", aligned, "mxfp4", "mxfp8"},
		{"lm_head int8 base", transform26B, "model.lm_head.weight", aligned, "int8", "int8"},
		{"lm_head mxfp8 base", transform26B, "model.lm_head.weight", aligned, "mxfp8", "mxfp8"},
		...
		// nvfp4: uniform (no promotion yet, FP8 pipeline not validated)
		{"v_proj nvfp4 promoted layer", transform26B, "model.layers.0.self_attn.v_proj.weight", aligned, "nvfp4", "nvfp4"},
		...
		{"dense down_proj nvfp4 promoted", transform26B, "model.layers.0.mlp.down_proj.weight", aligned, "nvfp4", "nvfp4"},
		...
		// nvfp4 experts: uniform (no nvfp8 quantize mode in MLX)
		{"expert down_proj nvfp4 promoted layer", transform26B, "model.layers.0.moe.experts.42.down_proj.weight", aligned, "nvfp4", "nvfp4"},
		...
		{"k_proj 8 experts nvfp4", transform8E, "model.layers.0.self_attn.k_proj.weight", aligned, "nvfp4", "nvfp4"},
		...
		{"embed_tokens", transform26B, "model.embed_tokens.weight", aligned, "int4", ""},

// Package mistral provides the Mistral text model implementation for MLX.
package mistral
...
func init() {
	base.Register("MistralForCausalLM", newModel)
}

// Config holds Mistral model configuration.
type Config struct {

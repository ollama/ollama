...
#cgo cuda_v11 cuda_jetpack5 LDFLAGS: -L/usr/local/cuda-11/lib64
#cgo cuda_v12 cuda_jetpack6 LDFLAGS: -L/usr/local/cuda-12/lib64
...
#cgo windows,rocm LDFLAGS: -lggml_rocm

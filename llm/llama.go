...
#cgo linux,amd64,cuda CPPFLAGS: -DGGML_USE_CUBLAS -I/usr/local/cuda/include
#cgo linux,amd64,cuda LDFLAGS:  -lpthread -ldl -lrt -L/usr/local/cuda/lib64 -lcublas -lcublasLt -lcudart -lculibos -L/usr/local/cuda/targets/x86_64-linux/lib
#include <stdlib.h>
#include "llama.h"

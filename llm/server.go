...
func (s *llamaServer) Load(ctx context.Context, gpus discover.GpuInfoList, requireFull bool) error {
	// TODO: Num GPU will only allow reducing the number of layers offloaded, not increasing it
	...
	// TODO: Update based on changed NumGPU
	...
	s.loadRequest.GPULayers = s.estimate.GPULayers

...
//go:generate git -C gguf clean -fd
//go:generate git -C gguf apply ../patches/0001-custom-ollama-runner.patch
...
//go:generate cmake --build gguf/build/metal --target ollama-runner --config Release

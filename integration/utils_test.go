...
var (
	...
	rainbowExpected = []string{"water", "droplet", "mist", "glow", "refract", "reflect", "color", "spectrum", "raindrop", "atmosphere", "frequency", "end", "gold", "fortune", "blessing", "prosperity", "magic"}
)

...
To run and chat with [Llama 3.3](https://ollama.com/library/llama3.3):
...
Models from the Ollama library can be customized with a prompt. For example, to customize the `llama3.3` model:
...
```
$ ollama run llama3.3 "Summarize this file: $(cat README.md)"

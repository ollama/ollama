...
- [SearchBlox SearchAI](https://www.searchblox.com/searchai) (SearchAI unifies Hybrid Search, RAG, and low-risk GenAI across your data - generating trusted insights, 1:1 personalization, and agentic solutions that improve efficiency. Ollama is the default LLM provider for SearchAI - [SearchAI Ollama Integration](https://developer.searchblox.com/docs/llm-platform-configuration#ollama-native-api))

...
- [PromptingTools.jl](https://github.com/svilupp/PromptingTools.jl) with [example](https://github.com/svilupp/PromptingTools.jl/blob/main/examples/working_with_ollama.jl)

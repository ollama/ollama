...
- [Weave by W&B](https://weave-docs.wandb.ai/guides/integrations/local_models#openai-sdk-supported-local-model-runners) is an open source framework for tracking, experimenting with, evaluating, deploying, and improving LLM-based applications. Weave supports Ollama observability through OpenAI SDK.

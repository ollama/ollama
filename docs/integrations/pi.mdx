...
If you previously installed Pi from the old unmaintained `@mariozechner/pi-coding-agent` package, `ollama launch pi` will prompt to migrate you to the official package automatically.

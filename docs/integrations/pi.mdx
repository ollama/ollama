...
If you previously installed Pi from `@mariozechner/pi-coding-agent`, `ollama launch pi` can switch you to the official package automatically. Your Pi settings and installed extensions are kept.
...
This installs Pi if needed, migrates legacy installs to the official package, configures Ollama as a provider including web tools, and drops you into an interactive session.

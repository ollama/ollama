...
- [Instructions](#instructions)
  - [FROM (Required)](#from-required)
    ...
    - [Build from a Huggingface model](#build-from-a-huggingface-model)
  - [PARAMETER](#parameter)
...
#### Build from a Huggingface model

```modelfile
FROM hg://Qwen/Qwen2.5-1.5B-Instruct-GGUF/qwen2.5-1.5b-instruct-q8_0
```

The Huggingface model should be specified as a URL with the `hg://` prefix.

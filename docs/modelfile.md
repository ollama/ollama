...
| num_ctx        | Sets the context size in tokens (aka context length or window size) (eg. if your model was trained on 16K tokens, you can set it up to 16384). (Default: 2048)                                                                                          | int        | num_ctx 4096         |

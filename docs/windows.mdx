...
- HIP 7-capable AMD driver stack for ROCm acceleration, or a Vulkan-capable AMD Radeon driver for Vulkan acceleration

Ollama uses unicode characters for progress indication, which may render as unknown squares in some older terminal fonts in Windows 10. If you see this, try changing your terminal font settings.

<Note>
  Some RDNA2 / Radeon RX 6000 systems, including RX 6800-class cards, may not
  expose a compatible HIP runtime on current Windows AMD drivers. Vulkan is enabled by default

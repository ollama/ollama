...
- **AMD GPU (stable ROCm)**: `ollama-windows-amd64-rocm-stable.zip`
- **AMD GPU (nightly ROCm)**: `ollama-windows-amd64-rocm-nightly.zip` (experimental, bleeding-edge AMD GPU support)

...
| Family            | Cards and accelerators                                                                                                                                                  |
| ----------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AMD Radeon RX     | `9070 XT` `9070 GRE` `9070` `9060 XT` `7900 XTX` `7900 XT` `7900 GRE` `7800 XT` `7700 XT` `7600 XT` `7600` `6950 XT` `6900 XT` `6800 XT` `6800`   |
| AMD Radeon AI PRO | `R9700`                                                                                                                                                                 |
| AMD Radeon PRO    | `W7900` `W7800` `W7700` `W7600` `W7500` `W6800`                                                                                                                         |
| AMD Ryzen AI      | `Ryzen AI Max+ 395` `Ryzen AI Max 390` `Ryzen AI Max 385` `Ryzen AI 9 HX 475` `Ryzen AI 9 HX 470` `Ryzen AI 9 465` `Ryzen AI 9 HX 375` `Ryzen AI 9 HX 370` `Ryzen AI 9 365` |

...
Ollama bundles ROCm 10 libraries and requires a compatible AMD GPU driver on
Linux. You can install or upgrade using the `amdgpu-install` utility from
...
Ollama bundles ROCm 10 libraries and requires a HIP 7-capable AMD driver stack
on Windows.

| Family         | Cards and accelerators                                                                                               |
| -------------- | -------------------------------------------------------------------------------------------------------------------- |
| AMD Radeon RX  | `9070 XT` `9070 GRE` `9070` `9060 XT` `9060 XT LP` `9060` `7900 XTX` `7900 XT` `7900 GRE` `7800 XT` `7700 XT` `7600 XT` `7600`  |
| AMD Radeon AI PRO | `R9700` `R9600D` |
...
close. You can use the environment variable `HSA_OVERRIDE_GFX_VERSION` with
`x.y.z` syntax. For example, to force ROCm to try the `gfx1030` target, you
would set `HSA_OVERRIDE_GFX_VERSION="10.3.0"` as an environment variable for the
server. If you have an unsupported AMD GPU you can experiment using the list of
supported types below, but unsupported hardware may fail to run.
...
| gfx1032 | Radeon RX 6600 XT |
| gfx1033 | Van Gogh iGPU |
| gfx1034 | Radeon RX 6500 XT |
| gfx1035 | Radeon 680M |
| gfx1036 | Raphael iGPU |

...
CPU does not already have, and forcing a discrete and an integrated GPU into a
common backend so they can be split across may cost more than it gains. Measure
before adopting it.

...
For more tools, see [Integrations](/integrations). To connect an agent directly with an API key, see [Claude Code](/integrations/claude-code#connect-directly-to-ollama-cloud) or [Codex CLI](/integrations/codex#connect-directly-to-ollama-cloud).

...
For coding use cases, we recommend `glm-4.7-flash` for local use or cloud models for full context length:

- `glm-4.7-flash` (local, requires 23 GB of VRAM with 64000 tokens context length)
- `glm-4.7:cloud` (cloud)

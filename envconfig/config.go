...
func AsMap() map[string]EnvVar {
	ret := map[string]EnvVar{
		...
		"OLLAMA_NUM_DOWNLOAD_PARTS": {"OLLAMA_NUM_DOWNLOAD_PARTS", NumDownloadParts(), "Number of download parts"},
...
func NumDownloadParts() int {
	defaultNumDownloadParts := 16
	if s := Var("OLLAMA_NUM_DOWNLOAD_PARTS"); s != "" {
		if num, err := strconv.Atoi(s); err == nil {
			return num
		}
	}
	return defaultNumDownloadParts
}

...
$lib_env = [Environment]::GetEnvironmentVariable("OLLAMA_LLM_LIBRARY", "Process")
$gpu_env = [Environment]::GetEnvironmentVariable("OLLAMA_INTEL_GPU", "Process")
$vk_env = [Environment]::GetEnvironmentVariable("GGML_VK_DISABLE_HOST_VISIBLE_VIDMEM", "Process")

Write-Host "   OLLAMA_LLM_LIBRARY               = $lib_env" -ForegroundColor White
Write-Host "   OLLAMA_INTEL_GPU                 = $gpu_env" -ForegroundColor White
Write-Host "   GGML_VK_DISABLE_HOST_VISIBLE_VIDMEM = $vk_env" -ForegroundColor White

...
// tfca is a helper to create ToolCallFunctionArguments from a map
func tfca(m map[string]any) api.ToolCallFunctionArguments {
	return testArgs(m)
}

// olmo3ArgsComparer provides cmp options for comparing ToolCallFunctionArguments
var olmo3ArgsComparer = cmp.Comparer(func(a, b api.ToolCallFunctionArguments) bool {
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "get_weather",
						Arguments: tfca(map[string]any{"location": "San Francisco"}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "get_weather",
						Arguments: tfca(map[string]any{"location": "NYC"}),
					},
				},
			},
		},
...
get_weather(location="New York")</function_calls>`,
			expectedCalls: []api.ToolCall{
				...
				},
				{
					Function: api.ToolCallFunction{
						Name:      "get_weather",
						Arguments: tfca(map[string]any{"location": "New York"}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						...
						Arguments: tfca(map[string]any{"value": int64(72)}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "set_price",
						Arguments: tfca(map[string]any{"amount": 19.99}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "toggle_setting",
						Arguments: tfca(map[string]any{"enabled": true}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "clear_value",
						Arguments: tfca(map[string]any{"field": nil}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "process_items",
						Arguments: tfca(map[string]any{"items": []any{"apple", "banana", "cherry"}}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "search",
						Arguments: tfca(map[string]any{"query": "hello world"}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "search",
						Arguments: tfca(map[string]any{"query": `say "hello"`}),
					},
				},
			},
		},
			...
			expectedCalls: []api.ToolCall{
				{
					Function: api.ToolCallFunction{
						Name:      "get_weather",
						Arguments: tfca(map[string]any{"location": "SF"}),
					},
				},
			},
		},
...
get_time(timezone="PST")`,
			expected: []api.ToolCall{
				...
				},
				{
					Function: api.ToolCallFunction{
						Name:      "get_time",
						Arguments: tfca(map[string]any{"timezone": "PST"}),
					},
				},
			},
		},

...
// into caches that support TurboQuant-aware encoding (e.g. TurboQuantCache).
// Qwen2 includes a learnable bias on the K projection; without bias wiring,
// TQ's WHT rotation spreads the bias across all channels.

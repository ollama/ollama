...
func New(c fs.Config) (model.Model, error) {
	if c.Uint("expert_count") == 0 {
		return nil, fmt.Errorf("qwen35moe: expected MoE model but expert_count is 0")
	}
	...
	if !hasZero || !hasFull {
		return nil, fmt.Errorf("qwen35moe: invalid attention.head_count_kv array; expected mix of zero and non-zero values")
	}
...
func init() {
	...
	model.Register("qwen3_5_moe", New)
	model.Register("qwen3.5moe", New)
}

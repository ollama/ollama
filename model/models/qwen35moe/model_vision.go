...
func (m *VisionPatchMerger) Forward(ctx ml.Context, visionOutputs ml.Tensor, opts VisionOptions) ml.Tensor {
...
// Forward computes the vision model output (no deepstack)
func (m *VisionModel) Forward(ctx ml.Context, pixelValues ml.Tensor, grid *Grid) ml.Tensor {
	...
	return m.PatchMerger.Forward(ctx, hiddenStates, m.VisionOptions)
}

func newVisionModel(c fs.Config) *VisionModel {
	return &VisionModel{
		Layers: make([]VisionEncoderLayer, c.Uint("vision.block_count", 27)),

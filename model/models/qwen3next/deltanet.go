...
func (gdn *GatedDeltaNet) deltaNetChunked(
	...
	// Collect chunk outputs for balanced concat tree merge below.
	// Using ml.Tensor.SetInplace would crash on Metal and Vulkan because
	// Ollama's vendored GGML lacks GGML_OP_SET support on those backends.

...
type DeepSeek3TerminusRenderer struct {
	isThinking bool
}

func (r *DeepSeek3TerminusRenderer) Render(messages []api.Message, tools []api.Tool, thinkValue *api.ThinkValue) (string, error) {

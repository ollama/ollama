...
func mockRenderer(msgs []api.Message, tools []api.Tool, think *api.ThinkValue) (string, error) {
	return "mock-output", nil
}

func TestRegisterCustomRenderer(t *testing.T) {
	// Register a custom renderer
	Register("custom-renderer", mockRenderer)
...
func TestOverrideBuiltInRenderer(t *testing.T) {
	...
	Register("qwen3-coder", mockRenderer)

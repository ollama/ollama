...
//
// This test enforces two properties:
//
...
//
// The items sub-object uses {"type", "description"} which get_json_schema()
// never produces inside items — this catches the real map key alphabetization
// bug but with an out-of-training-distribution example. Needs rewriting to
// use get_json_schema() examples like list[dict[str, int]].

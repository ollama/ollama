...
var recommendedModels = []ModelItem{
	...
	{Name: "glm-5.2:cloud", Description: "Reasoning and code generation", Recommended: true, Details: api.ModelDetails{ContextLength: 1_048_576}, MaxOutputTokens: 131_072},
...
var extraCloudModelLimits = map[string]cloudModelLimit{
	...
	"glm-5.2":             {Context: 1_048_576, Output: 131_072},

...
func TestLaunchIntegration_ManagedSingleIntegrationCanConfigureWithModelList(t *testing.T) {
	...
	if diff := compareStringSlices(runner.configuredModelLists, [][]string{{"gemma4", "mimo-v2.5-pro:cloud", "kimi-k2.6:cloud", "qwen3.5:cloud", "glm-5.1:cloud", "minimax-m2.7:cloud", "qwen3.5", "qwen3:8b"}}); diff != "" {

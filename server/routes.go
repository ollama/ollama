...
func (s *Server) GenerateRoutes() (http.Handler, error) {
	...
	r.POST("/v1/responses", s.withInferenceRequestLogging("/v1/responses", middleware.ResponsesHistoryMiddleware(), s.responsesCompactionMiddleware(), cloudPassthroughMiddleware(cloudErrRemoteInferenceUnavailable), middleware.ResponsesMiddleware(), s.ChatHandler)...)

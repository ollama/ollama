...
func (s *Server) ChatHandler(c *gin.Context) {
	...
	go func() {
		...
		for {
			...
			applyFormatImmediatelyForGemma4 := m.Config.Parser == "gemma4" && (req.Think == nil || !req.Think.Bool())
			if req.Format != nil && structuredOutputsState == structuredOutputsState_None && !applyFormatImmediatelyForGemma4 && ((builtinParser != nil || thinkingState != nil) && slices.Contains(m.Capabilities(), model.CapabilityThinking)) {
				currentFormat = nil
			}

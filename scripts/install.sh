...
BUNDLE_TGZ="$TEMP_DIR/ollama.tgz"
curl --fail --show-error --location --progress-bar \
    "https://ollama.com/download/ollama-linux-${ARCH}.tgz${VER_PARAM}" -o "$BUNDLE_TGZ"

status "Download complete. Replacing previous installation (if any)."
...
$SUDO tar -xzf "$BUNDLE_TGZ" -C "$OLLAMA_INSTALL_DIR"

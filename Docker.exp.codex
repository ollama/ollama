...
RUN case "${TARGETARCH}" in \
        ...
        *) cmake_arch=${TARGETARCH} ;; \
    esac \
    && curl -fsSL https://github.com/Kitware/CMake/releases/download/v${CMAKEVERSION}/cmake-${CMAKEVERSION}-linux-${cmake_arch}.tar.gz \

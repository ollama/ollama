...
func (t *Tensor) Stride(n int) int64 {
	...
	// TODO - this isn't right for single length initial dimensions.  Their stride value in GGML is a very large (garbage?) number
	r := rev[4-t.nDims:]
	return int64(t.t.nb[r[n]])
}
...
func (t *Tensor) Rope(
	...
	// TODO - does this need mutation for offsets?

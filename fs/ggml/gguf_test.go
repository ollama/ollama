...
func TestWriteGGUFConcurrencyLimitCapsGOMAXPROCS(t *testing.T) {
	...
	if got := ggufWriteConcurrencyLimitForBudget(0); got != 4 {
		t.Fatalf("ggufWriteConcurrencyLimitForBudget(0) = %d, want 4", got)
	}
}
...
func TestWriteGGUFConcurrencyLimitUsesLowerGOMAXPROCS(t *testing.T) {
	...
	if got := ggufWriteConcurrencyLimitForBudget(0); got != 2 {
		t.Fatalf("ggufWriteConcurrencyLimitForBudget(0) = %d, want 2", got)
	}
}
